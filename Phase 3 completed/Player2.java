...
public class Player2 extends AbstractPlayer {
    protected int[] groupHand, groupHand1a, groupHand1b;
    protected int[] gapCount, gapCount1a, gapCount1b;
    protected int[] discardReplacement, discard1a, discard1b, drawReplacement;
    protected int[] rangeMax, rangeMax1a, rangeMax1b;
    protected int aveRange, offRange;
    ...
    protected void level1review(int[] value) {
    ...
    protected void review1a(int[] value) {    
        while (true) {
            ...
            while (true) {
                ...
                for (int i = 0; i < rackSize; i++) {
                    ...
                    if (i == group && discard1a[value[i]] >= 0 && group == discard1a[value[i]] % cardKey) {
                        if (!scan[group]) {
                            reviewGroup = group;
                    ...
                    if (val == 0) {
                        if (max > min + 1) {
                            ...
                            while (total > 0) {
                                ...
                                while (count > 0) {
                                    if (discard1a[k] >= -1 && discard1a[k] < rackSize) {
                                        discard1a[k] = group;
                                        count--;
                                    } else {
    ...
    protected void review1b(int[] value) {    
        while (true) {
            boolean[] scan = new boolean[rackSize];
            for (int i = 0; i < rackSize; i++) {
                if (gapCount1b[i] == 0) {
                    ...
                    if (val == 0) {
                        if (max > min + 1) {
                            ...
                            while (total > 0) {
                                ...
                                while (count > 0) {
                                    if (discard1b[k] >= -1 && discard1b[k] < rackSize) {
                                        discard1b[k] = group;
                                        count--;
                                    } else {
                                        for (int pos = 0; pos < rackSize; pos++) {
    ...
    protected void level2review(int[] value) {
    ...
    public boolean determine_use(int value, boolean isDiscardCard) {
        ...
        return secondCheck(value, isDiscardCard);
    }
    ...
    protected boolean goodChoice(int value, boolean isDiscardCard) {
